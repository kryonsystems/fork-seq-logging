...
describe('SeqLogger', () => {
   ...
   describe('constructor()', () => {
      ...
      it('uses configuration arguments that are provided', () => {
       ...
       it('http keep-alive-agent created', () => {
           let logger = new SeqLogger({serverUrl: 'http://my-seq/test'});
           assert.notEqual(logger._keepaliveAgent, null);
           assert.equal(logger._keepaliveAgent.protocol, 'http:');
       });

       it('https keep-alive-agent created', () => {
           let logger = new SeqLogger({serverUrl: 'https://my-seq/test'});
           assert.notEqual(logger._keepaliveAgent, null);
           assert.equal(logger._keepaliveAgent.protocol, 'https:');
       });
